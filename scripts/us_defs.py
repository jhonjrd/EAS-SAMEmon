#!/usr/bin/env python3
#
# us_defs.py - North American Alert Monitor (USA Definitions)
# County and area data for the SAME standard in the USA.
#

# Standard county subdivisions (P)
US_PART_NAMES = {
    '0': 'the whole county',
    '1': 'northwest',
    '2': 'north',
...
# US County Dictionary (SSCCC -> Name)
# Automatically generated from SameCode_US.txt
US_SAME_CODE = {
    '01001': 'Autauga, AL',
    '01003': 'Baldwin, AL',
    '01005': 'Barbour, AL',
    ...
    '70212': 'Melekeok*, PW',
    '70214': 'Ngaraard, PW',
    '70218': 'Ngarchelong, PW',
    '70222': 'Ngardmau, PW',
    '70224': 'Ngatpang, PW',
    '70226': 'Ngchesar, PW',
    '70227': 'Ngernmlengui*, PW',
    '70228': 'Ngiwal, PW',
    '70350': 'Peleliu, PW',
    '70370': 'Sonsorol, PW',
    '72001': 'Adjuntas, PR',
    ...
    '72151': 'Yabucoa, PR',
    '72153': 'Yauco, PR',
    '74050': 'Baker Island, UM',
    '74100': 'Howland Island, UM',
    '74150': 'Jarvis Island, UM',
    '74200': 'Johnston Island, UM',
    '74250': 'Kingman Reef, UM',
    '74300': 'Midway Islands, UM',
    '74350': 'Navassa Island, UM',
    '74400': 'Palmyra Atoll, UM',
    '74450': 'Wake Island, UM',
    '78010': 'St. Croix, VI',
    '78020': 'St. John, VI',
    '78030': 'St. Thomas, VI',
}

# Estados de EE.UU. (campo SS del PSSCCC)
US_STATES = {
    ...
    '56': 'Wyoming',              '66': 'Guam',
    '69': 'Northern Mariana Is.', '72': 'Puerto Rico',
    '78': 'U.S. Virgin Islands',
}

def decode_us_area(code):
    """Convierte un código PSSCCC de EE.UU. a (lugar, estado)."""
    if len(code) < 6:
        return code, "Unknown State"
    ...
    state = US_STATES.get(SS, f"State {SS}")
    
    if CCC == '000':
        # Entire state — neutral English sentinel, translated in the UI
        place = f"all of {state}"
    else:
        # Condado específico
        county_full = US_SAME_CODE.get(SSCCC, f"County {CCC}")
        # Intentar quitar la abreviatura del estado si ya está en 'state'
        if ', ' in county_full:
            place = county_full.split(', ')[0]
        else:
            place = county_full
            
        # Añadir parte del condado si P > 0
        if P != '0':
            part = US_PART_NAMES.get(P, f"parte {P} de")
            place = f"{part} {place}"
